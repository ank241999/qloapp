...
/* Smarty version 3.1.39, created on 2024-01-10 07:54:44
  from 'C:\xampp\htdocs\cslhotel\cslhotel\themes\hotel-reservation-theme\order-carrier-advanced.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_659e3f34d1fdd5_68516815',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4d2f82c54230189e4d19dc4219b9097bada3eeed' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cslhotel\\cslhotel\\themes\\hotel-reservation-theme\\order-carrier-advanced.tpl',
      1 => 1681739898,
      2 => 'file',
    ),
  ),
...
function content_659e3f34d1fdd5_68516815 (Smarty_Internal_Template $_smarty_tpl) {
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,NULL,$_prefixVariable29), ENT_QUOTES, 'UTF-8', true);?>
...
$__foreach_option_76_saved = $_smarty_tpl->tpl_vars['option'];
?>
...
$_smarty_tpl->tpl_vars['carrier']->iteration++;
$_smarty_tpl->tpl_vars['carrier']->last = $_smarty_tpl->tpl_vars['carrier']->iteration === $_smarty_tpl->tpl_vars['carrier']->total;
$__foreach_carrier_78_saved = $_smarty_tpl->tpl_vars['carrier'];
?>
                                                                        ...
                                                                        <?php
$_smarty_tpl->tpl_vars['carrier'] = $__foreach_carrier_78_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
...
$__foreach_product_79_saved = $_smarty_tpl->tpl_vars['product'];
?>
...
$_smarty_tpl->tpl_vars['product'] = $__foreach_product_79_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);
...
$_smarty_tpl->tpl_vars['carrier']->iteration++;
$_smarty_tpl->tpl_vars['carrier']->last = $_smarty_tpl->tpl_vars['carrier']->iteration === $_smarty_tpl->tpl_vars['carrier']->total;
$__foreach_carrier_80_saved = $_smarty_tpl->tpl_vars['carrier'];
...
$_smarty_tpl->tpl_vars['product']->index++;
$_smarty_tpl->tpl_vars['product']->last = $_smarty_tpl->tpl_vars['product']->iteration === $_smarty_tpl->tpl_vars['product']->total;
$__foreach_product_81_saved = $_smarty_tpl->tpl_vars['product'];
?>
                                                                                        <?php if ($_smarty_tpl->tpl_vars['product']->index == 4) {?>
                                                                                            <acronym title="
																	<?php }?>
...
$_smarty_tpl->tpl_vars['product'] = $__foreach_product_81_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);
}?></td></tr><?php }
$_smarty_tpl->tpl_vars['carrier'] = $__foreach_carrier_80_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></table><?php }?></div></div> <!-- end delivery_option --><?php
$_smarty_tpl->tpl_vars['option'] = $__foreach_option_76_saved;
}
...
$__foreach_address_82_saved = $_smarty_tpl->tpl_vars['address'];
...
$_smarty_tpl->tpl_vars['address'] = $__foreach_address_82_saved;
}
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,NULL,"step=1&back=".((string)$_smarty_tpl->tpl_vars['back']->value).$_prefixVariable30), ENT_QUOTES, 'UTF-8', true);?>
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,NULL,"step=1".$_prefixVariable31), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Previous'),$_smarty_tpl ) );?>
" class="button-exclusive btn btn-default">
                                <i class="icon-chevron-left"></i>
                                <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Continue shopping'),$_smarty_tpl ) );?>
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,NULL,$_prefixVariable32), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Previous'),$_smarty_tpl ) );?>
" class="button-exclusive btn btn-default">
                            <i class="icon-chevron-left"></i>
                            <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Continue shopping'),$_smarty_tpl ) );?>
...
$_block_repeat=true;
echo $_block_plugin91->addJsDefL(array('name'=>'txtProduct'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin91->addJsDefL(array('name'=>'txtProduct'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
...
$_block_repeat=true;
echo $_block_plugin92->addJsDefL(array('name'=>'txtProducts'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin92->addJsDefL(array('name'=>'txtProducts'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
}
...
$_block_repeat=true;
echo $_block_plugin93->addJsDefL(array('name'=>'msg_order_carrier'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin93->addJsDefL(array('name'=>'msg_order_carrier'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
}
}
