...
/* Smarty version 3.1.39, created on 2024-01-10 07:54:44
  from 'C:\xampp\htdocs\cslhotel\cslhotel\themes\hotel-reservation-theme\order-address.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_659e3f34c1c8f7_54630359',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f078a69cb7b34cf937465013d2f03c80d06e9199' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cslhotel\\cslhotel\\themes\\hotel-reservation-theme\\order-address.tpl',
      1 => 1681739898,
      2 => 'file',
    ),
  ),
...
function content_659e3f34c1c8f7_54630359 (Smarty_Internal_Template $_smarty_tpl) {
		...
		<div class="col-xs-12 col-sm-6">
			<div id="address_invoice_form" class="select form-group selector1"<?php if ($_smarty_tpl->tpl_vars['cart']->value->id_address_invoice == $_smarty_tpl->tpl_vars['cart']->value->id_address_delivery) {?> style="display: none;"<?php }?>>
				<?php if (count($_smarty_tpl->tpl_vars['addresses']->value) > 1) {?>
					...
					<?php
$__section_address_6_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['addresses']->value) ? count($_loop) : max(0, (int) $_loop));
$__section_address_6_start = $__section_address_6_loop - 1;
$__section_address_6_total = min(($__section_address_6_start+ 1), $__section_address_6_loop);
$_smarty_tpl->tpl_vars['__smarty_section_address'] = new Smarty_Variable(array());
if ($__section_address_6_total !== 0) {
for ($__section_address_6_iteration = 1, $_smarty_tpl->tpl_vars['__smarty_section_address']->value['index'] = $__section_address_6_start; $__section_address_6_iteration <= $__section_address_6_total; $__section_address_6_iteration++, $_smarty_tpl->tpl_vars['__smarty_section_address']->value['index'] -= 1){
?>
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,NULL,"back=".((string)$_smarty_tpl->tpl_vars['back_order_page']->value)."?step=1&select_address=1".$_prefixVariable26), ENT_QUOTES, 'UTF-8', true);?>
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,NULL,"back=".((string)$_smarty_tpl->tpl_vars['back_order_page']->value)."?step=1".$_prefixVariable27), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Add'),$_smarty_tpl ) );?>
" class="button button-small btn btn-default">
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink($_smarty_tpl->tpl_vars['back_order_page']->value,true,NULL,$_prefixVariable28), ENT_QUOTES, 'UTF-8', true);?>
...
$_block_repeat=true;
echo $_block_plugin85->addJsDefL(array('name'=>'txtProduct'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin85->addJsDefL(array('name'=>'txtProduct'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
...
$_block_repeat=true;
echo $_block_plugin86->addJsDefL(array('name'=>'txtProducts'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin86->addJsDefL(array('name'=>'txtProducts'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
...
$_block_repeat=true;
echo $_block_plugin87->addJsDefL(array('name'=>'CloseTxt'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin87->addJsDefL(array('name'=>'CloseTxt'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
}
...
$_block_repeat=true;
echo $_block_plugin88->addJsDefL(array('name'=>'titleInvoice'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
echo addcslashes($_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 'default'),'\'');
$_block_repeat=false;
echo $_block_plugin88->addJsDefL(array('name'=>'titleInvoice'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
...
$_block_repeat=true;
echo $_block_plugin89->addJsDefL(array('name'=>'titleDelivery'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
echo addcslashes($_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 'default'),'\'');
$_block_repeat=false;
echo $_block_plugin89->addJsDefL(array('name'=>'titleDelivery'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
...
$_block_repeat=true;
echo $_block_plugin90->addJsDefL(array('name'=>'liUpdate'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
echo addcslashes($_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 'default'),'\'');
$_block_repeat=false;
echo $_block_plugin90->addJsDefL(array('name'=>'liUpdate'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
}
}
