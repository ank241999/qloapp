...
/* Smarty version 3.1.39, created on 2024-01-10 07:54:44
  from 'C:\xampp\htdocs\cslhotel\cslhotel\themes\hotel-reservation-theme\modules\blocknewsletter\blocknewsletter.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_659e3f34047504_36189327',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '06a3eb73d733d31b73af3240b81cdc16cf95815d' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cslhotel\\cslhotel\\themes\\hotel-reservation-theme\\modules\\blocknewsletter\\blocknewsletter.tpl',
      1 => 1681739898,
      2 => 'file',
    ),
  ),
...
function content_659e3f34047504_36189327 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
$_block_repeat=true;
echo $_block_plugin50->addJsDefL(array('name'=>'placeholder_blocknewsletter'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin50->addJsDefL(array('name'=>'placeholder_blocknewsletter'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
...
$_block_repeat=true;
echo $_block_plugin51->addJsDefL(array('name'=>'email_js_error'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin51->addJsDefL(array('name'=>'email_js_error'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
...
$_block_repeat=true;
echo $_block_plugin52->addJsDefL(array('name'=>'alert_blocknewsletter'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin52->addJsDefL(array('name'=>'alert_blocknewsletter'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
}
}
