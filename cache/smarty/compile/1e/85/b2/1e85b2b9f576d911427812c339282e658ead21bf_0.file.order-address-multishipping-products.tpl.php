...
/* Smarty version 3.1.39, created on 2024-01-10 07:54:44
  from 'C:\xampp\htdocs\cslhotel\cslhotel\themes\hotel-reservation-theme\order-address-multishipping-products.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_659e3f34abe3c1_12096365',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1e85b2b9f576d911427812c339282e658ead21bf' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cslhotel\\cslhotel\\themes\\hotel-reservation-theme\\order-address-multishipping-products.tpl',
      1 => 1681739898,
      2 => 'file',
    ),
  ),
...
function content_659e3f34abe3c1_12096365 (Smarty_Internal_Template $_smarty_tpl) {
...
$__foreach_product_72_saved = $_smarty_tpl->tpl_vars['product'];
?>
...
?>
		<?php
$_smarty_tpl->tpl_vars['product'] = $__foreach_product_72_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
		</tbody>
	</table>
</div>
<?php $_block_plugin75 = isset($_smarty_tpl->smarty->registered_plugins['block']['addJsDefL'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['addJsDefL'][0][0] : null;
...
$_block_repeat=true;
echo $_block_plugin75->addJsDefL(array('name'=>'CloseTxt'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin75->addJsDefL(array('name'=>'CloseTxt'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
...
$_block_repeat=true;
echo $_block_plugin76->addJsDefL(array('name'=>'QtyChanged'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin76->addJsDefL(array('name'=>'QtyChanged'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
...
$_block_repeat=true;
echo $_block_plugin77->addJsDefL(array('name'=>'ShipToAnOtherAddress'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin77->addJsDefL(array('name'=>'ShipToAnOtherAddress'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
}
}
