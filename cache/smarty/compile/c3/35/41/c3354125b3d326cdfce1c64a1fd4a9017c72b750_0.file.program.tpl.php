...
/* Smarty version 3.1.39, created on 2024-01-10 07:54:44
  from 'C:\xampp\htdocs\cslhotel\cslhotel\themes\hotel-reservation-theme\modules\referralprogram\views\templates\front\program.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_659e3f348575d0_22493024',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c3354125b3d326cdfce1c64a1fd4a9017c72b750' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cslhotel\\cslhotel\\themes\\hotel-reservation-theme\\modules\\referralprogram\\views\\templates\\front\\program.tpl',
      1 => 1681739898,
      2 => 'file',
    ),
  ),
...
function content_659e3f348575d0_22493024 (Smarty_Internal_Template $_smarty_tpl) {
...
" class="std">
				...
				<tbody>
					<?php
$__section_friends_4_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['nbFriends']->value) ? count($_loop) : max(0, (int) $_loop));
$__section_friends_4_start = min(0, $__section_friends_4_loop);
$__section_friends_4_total = min(($__section_friends_4_loop - $__section_friends_4_start), $__section_friends_4_loop);
$_smarty_tpl->tpl_vars['__smarty_section_friends'] = new Smarty_Variable(array());
if ($__section_friends_4_total !== 0) {
for ($_smarty_tpl->tpl_vars['__smarty_section_friends']->value['iteration'] = 1, $_smarty_tpl->tpl_vars['__smarty_section_friends']->value['index'] = $__section_friends_4_start; $_smarty_tpl->tpl_vars['__smarty_section_friends']->value['iteration'] <= $__section_friends_4_total; $_smarty_tpl->tpl_vars['__smarty_section_friends']->value['iteration']++, $_smarty_tpl->tpl_vars['__smarty_section_friends']->value['index']++){
?>
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getModuleLink('referralprogram','email',array('height'=>'500','width'=>'600','mail'=>$_prefixVariable15),true), ENT_QUOTES, 'UTF-8', true);?>
...
<?php $_block_plugin73 = isset($_smarty_tpl->smarty->registered_plugins['block']['addJsDefL'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['addJsDefL'][0][0] : null;
...
$_block_repeat=true;
echo $_block_plugin73->addJsDefL(array('name'=>'ThickboxI18nClose'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin73->addJsDefL(array('name'=>'ThickboxI18nClose'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
...
$_block_repeat=true;
echo $_block_plugin74->addJsDefL(array('name'=>'ThickboxI18nOrEscKey'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin74->addJsDefL(array('name'=>'ThickboxI18nOrEscKey'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
