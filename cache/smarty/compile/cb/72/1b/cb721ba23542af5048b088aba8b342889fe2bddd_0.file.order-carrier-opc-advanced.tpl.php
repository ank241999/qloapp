...
/* Smarty version 3.1.39, created on 2024-01-10 07:54:44
  from 'C:\xampp\htdocs\cslhotel\cslhotel\themes\hotel-reservation-theme\order-carrier-opc-advanced.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_659e3f34e03af8_20470332',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'cb721ba23542af5048b088aba8b342889fe2bddd' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cslhotel\\cslhotel\\themes\\hotel-reservation-theme\\order-carrier-opc-advanced.tpl',
      1 => 1681739898,
      2 => 'file',
    ),
  ),
...
function content_659e3f34e03af8_20470332 (Smarty_Internal_Template $_smarty_tpl) {
...
$__foreach_option_85_saved = $_smarty_tpl->tpl_vars['option'];
?>
...
$__foreach_carrier_86_saved = $_smarty_tpl->tpl_vars['carrier'];
?>
...
"/>
                                                        ...
                                                        <?php }?>
                                                    <?php
$_smarty_tpl->tpl_vars['carrier'] = $__foreach_carrier_86_saved;
}
...
$_smarty_tpl->tpl_vars['carrier']->iteration++;
$_smarty_tpl->tpl_vars['carrier']->last = $_smarty_tpl->tpl_vars['carrier']->iteration === $_smarty_tpl->tpl_vars['carrier']->total;
$__foreach_carrier_87_saved = $_smarty_tpl->tpl_vars['carrier'];
?>
                                                        ...
                                                        <?php
$_smarty_tpl->tpl_vars['carrier'] = $__foreach_carrier_87_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
...
$__foreach_product_88_saved = $_smarty_tpl->tpl_vars['product'];
?>
...
if (!$_smarty_tpl->tpl_vars['product']->last) {?>,&nbsp;<?php } else { ?>)<?php }
                                                            ...
                                                            <?php
$_smarty_tpl->tpl_vars['product'] = $__foreach_product_88_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                                        <?php }?>
                                                    </td>
...
$_smarty_tpl->tpl_vars['carrier']->iteration++;
$_smarty_tpl->tpl_vars['carrier']->last = $_smarty_tpl->tpl_vars['carrier']->iteration === $_smarty_tpl->tpl_vars['carrier']->total;
$__foreach_carrier_89_saved = $_smarty_tpl->tpl_vars['carrier'];
?>
...
$_smarty_tpl->tpl_vars['product']->index++;
$_smarty_tpl->tpl_vars['product']->last = $_smarty_tpl->tpl_vars['product']->iteration === $_smarty_tpl->tpl_vars['product']->total;
$__foreach_product_90_saved = $_smarty_tpl->tpl_vars['product'];
?>
                                                                        <?php if ($_smarty_tpl->tpl_vars['product']->index == 4) {?>
                                                                            <acronym title="
                                                                        <?php }?>
...
if (!$_smarty_tpl->tpl_vars['product']->last) {?>,&nbsp;<?php } else { ?>)<?php }
                                                                    ...
                                                                    <?php
$_smarty_tpl->tpl_vars['product'] = $__foreach_product_90_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                                                <?php }?>
                                                            </td>
                                                    ...
                                                    <?php }?>
                                                <?php
$_smarty_tpl->tpl_vars['carrier'] = $__foreach_carrier_89_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                            </table>
                                        <?php }?>
                            ...
                            <?php
$_smarty_tpl->tpl_vars['option'] = $__foreach_option_85_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
...
$__foreach_address_91_saved = $_smarty_tpl->tpl_vars['address'];
?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                ...
                                <?php }?>
                                <?php
$_smarty_tpl->tpl_vars['address'] = $__foreach_address_91_saved;
}
...
$_block_repeat=true;
echo $_block_plugin94->addJsDefL(array('name'=>'msg_order_carrier'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin94->addJsDefL(array('name'=>'msg_order_carrier'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
